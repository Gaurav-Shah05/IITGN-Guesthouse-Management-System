...
class billForm(FlaskForm):
    bill_id = IntegerField('Bill ID', validators=[DataRequired()])
    date_created = DateField('Date Created', validators=[DataRequired()])
    time_created = TimeField('Time Created', validators=[DataRequired()])
    ...
    paid_status = BooleanField('Paid Status', validators=[DataRequired()])
